  ...
  return (
    <div>
      ...
      <section className="mobile-view">
        <div className="box-image">
          <img src={mobile} alt="image oa a mobile phone" />
        </div>
      ...
      <section className="fingerprint-verification">
        <div className="box-image">
          <img src={verification} alt="fingerprint image" />
        </div>
        <div className="box-one">
      ...
      <section className="tracking">
        ...
        <p id="second-p">
          It helps the school management to keep track of students in school and
          also to be able to know when they’ve left school.
        </p>
      </section>
    </div>
  );
